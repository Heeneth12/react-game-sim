...
function GamePlayer() {
  useEffect(() => {
    // Run any initialization code for your game
    const script = document.createElement("script");
    script.type = "text/javascript";
    script.innerHTML = gameCode;
    document.head.appendChild(script);

    return () => {
      // Clean up or pause the game when the component unmounts
      // For example: cleanup code, removing event listeners, etc.
    };
  }, []);

  return (
    <div>
      {/* Other React components or elements can go here */}
